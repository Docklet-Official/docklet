...
#  Copyright (c) 2026 Docklet  |  https://github.com/Docklet-Official/docklet
# ══════════════════════════════════════════════════════════════
...
REPO_URL="https://github.com/Docklet-Official/docklet.git"
...
banner() {
  ...
  echo "  ║         https://github.com/Docklet-Official/docklet  ║"
  echo "  ╚══════════════════════════════════════════════════════╝"
  echo -e "${NC}"
}
